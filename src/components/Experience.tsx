...
function SceneRig({ focusRef, faceLightRef }: any) {
...
function CharacterWorkspace({ interactiveMode, faceLightRef, focusRef }: any) {
  ...
  const leftHandTargetRef = useRef<THREE.Group>(null!);
  const rightHandTargetRef = useRef<THREE.Group>(null!);
  ...
  const solveArm = (upper: any, fore: any, hand: any, target: any, side: any, delta: any, typingWave: any) => {
...
export default function Experience({ interactiveMode }: { interactiveMode: boolean }) {
  ...
  return (
    <>
      ...
      <fog attach="fog" args={['#000000', 6.2, 24]} />
